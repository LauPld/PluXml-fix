...
if (!empty($_POST)) { # Création, mise à jour, suppression ou aperçu
	...
	if (isset($_POST['update']) or isset($_POST['publish']) or isset($_POST['moderate']) or isset($_POST['draft'])) {
		...
		$escapedUrl = preg_quote($url, '/'); // Échapper les caractères spéciaux pour l'utilisation dans une expression régulière
		foreach ($plxAdmin->plxGlob_arts->aFiles as $numart => $filename) {
    		if (preg_match("/^_?[0-9]{4}.([0-9,|home|draft]*).[0-9]{3}.[0-9]{12}.$escapedUrl.xml$/", $filename)) {
	...
	<div class="grid">
			...
			<fieldset>
				<div class="grid">
					<div class="col sml-12">
						<?php $escapedArtId = htmlspecialchars($artId, ENT_QUOTES, 'UTF-8');
						plxUtils::printInput('artId', $escapedArtId, 'hidden'); ?>
					...
					<div class="col sml-12 small">
						<?php if ($artId != '' and $artId != '0000') : ?>
							...
							<small>
								...
								<a onclick="this.target=\'_blank\';return true;" href="<?php echo htmlentities($link, ENT_QUOTES, 'UTF-8') ?>" title="<?php echo htmlentities(L_LINK_ACCESS, ENT_QUOTES, 'UTF-8') ?> : <?php echo htmlspecialchars($link, ENT_QUOTES, 'UTF-8') ?>"><?php echo htmlspecialchars($link, ENT_QUOTES, 'UTF-8') ?></a>
							</small>
						<?php endif; ?>
					</div>
				</div>
		...
		<div class="sidebar col sml-12 med-5 lrg-4">
			...
			<fieldset>
				<div class="grid">
					<div class="col sml-12">
						...
						if ($_SESSION['profil'] < PROFIL_WRITER)
							...
							echo htmlentities('<input type="hidden" id="id_author" name="author" value="' . $author . '" />', ENT_QUOTES, 'UTF-8');
				...
				<div class="grid">
					<div class="col sml-12">
						<label><?php echo htmlentities(L_ARTICLE_DATE, ENT_QUOTES, 'UTF-8') ?>&nbsp;:</label>
						<div class="inline-form publication">
							<?php
							plxUtils::printInput('date_publication_day', htmlspecialchars($date['day'], ENT_QUOTES, 'UTF-8'), 'text', '2-2', false, 'day'); ?>
							<?php
							plxUtils::printInput('date_publication_month', htmlspecialchars($date['month'], ENT_QUOTES, 'UTF-8'), 'text', '2-2', false, 'month'); ?>
							<?php
							plxUtils::printInput('date_publication_year', htmlspecialchars($date['year'], ENT_QUOTES, 'UTF-8'), 'text', '2-4', false, 'year'); ?>
							<?php
							plxUtils::printInput('date_publication_time', htmlspecialchars($date['time'], ENT_QUOTES, 'UTF-8'), 'text', '2-5', false, 'time'); ?>
							<a class="ico_cal" href="javascript:void(0)" onclick="dateNow('date_publication', <?php echo htmlspecialchars(json_encode(date('Z')), ENT_QUOTES, 'UTF-8'); ?>); return false;" title="<?php echo htmlspecialchars(L_NOW, ENT_QUOTES, 'UTF-8'); ?>">
				...
				<div class="grid">
					<div class="col sml-12">
						...
						<div class="inline-form creation">
							<?php
							plxUtils::printInput('date_creation_day', htmlspecialchars($date_creation['day'], ENT_QUOTES, 'UTF-8'), 'text', '2-2', false, 'day'); ?>
							<?php
							plxUtils::printInput('date_creation_month', htmlspecialchars($date_creation['month'], ENT_QUOTES, 'UTF-8'), 'text', '2-2', false, 'month'); ?>
							<?php
							plxUtils::printInput('date_creation_year', htmlspecialchars($date_creation['year'], ENT_QUOTES, 'UTF-8'), 'text', '2-4', false, 'year'); ?>
							<?php
							plxUtils::printInput('date_creation_time', htmlspecialchars($date_creation['time'], ENT_QUOTES, 'UTF-8'), 'text', '2-5', false, 'time'); ?>
							<a class="ico_cal" href="javascript:void(0)" onclick="dateNow('date_creation', <?php echo htmlspecialchars(json_encode(date('Z')), ENT_QUOTES, 'UTF-8') ?>); return false;" title="<?php echo htmlspecialchars(L_NOW, ENT_QUOTES, 'UTF-8'); ?>">
								<img src="theme/images/date.png" alt="calendar" />
							</a>
						</div>
					</div>
				...
				<div class="grid">
					<div class="col sml-12">
						<?php plxUtils::printInput('date_update_old', htmlspecialchars($date_update_old, ENT_QUOTES, 'UTF-8'), 'hidden'); ?>
						<label><?php echo L_DATE_UPDATE ?>&nbsp;:</label>
						<div class="inline-form update">
							<?php plxUtils::printInput('date_update_day', htmlspecialchars($date_update['day'], ENT_QUOTES, 'UTF-8'), 'text', '2-2', false, 'day'); ?>
							<?php plxUtils::printInput('date_update_month', htmlspecialchars($date_update['month'], ENT_QUOTES, 'UTF-8'), 'text', '2-2', false, 'month'); ?>
							<?php plxUtils::printInput('date_update_year', htmlspecialchars($date_update['year'], ENT_QUOTES, 'UTF-8'), 'text', '2-4', false, 'year'); ?>
							<?php plxUtils::printInput('date_update_time', htmlspecialchars($date_update['time'], ENT_QUOTES, 'UTF-8'), 'text', '2-5', false, 'time'); ?>
							<a class="ico_cal" href="javascript:void(0)" onclick="dateNow('date_update', <?php echo htmlspecialchars(json_encode(date('Z')), ENT_QUOTES, 'UTF-8') ?>); return false;" title="<?php echo htmlspecialchars(L_NOW, ENT_QUOTES, 'UTF-8'); ?>">
								<img src="theme/images/date.png" alt="calendar" />
							</a>
						</div>
					</div>
				...
				<div class="grid">
					<div class="col sml-12">
						...
						<?php $escapedTags = htmlspecialchars($tags, ENT_QUOTES, 'UTF-8');
						plxUtils::printInput('tags', $escapedTags, 'text', '25-255', false, false); ?>
				...
				<div class="grid">
					<div class="col sml-12">
						...
						<?php $escapedUrl = htmlspecialchars($url, ENT_QUOTES, 'UTF-8');
						plxUtils::printInput('url', $escapedUrl, 'text', '27-255'); ?>
					</div>
				</div>
				<div class="grid">
					<div class="col sml-12">
				...
				<?php if ($artId != '0000') : ?>
					<ul class="unstyled-list">
						<li>
							<a href="comments.php?a=<?php echo htmlspecialchars($artId, ENT_QUOTES, 'UTF-8'); ?>&amp;page=1" title="<?php echo htmlentities(L_ARTICLE_MANAGE_COMMENTS_TITLE, ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlentities(L_ARTICLE_MANAGE_COMMENTS, ENT_QUOTES, 'UTF-8'); ?></a>
							<?php
							...
							?>
							<ul>
								<li><?php echo htmlspecialchars(L_COMMENT_OFFLINE, ENT_QUOTES, 'UTF-8'); ?> : <a title="<?php echo htmlspecialchars(L_NEW_COMMENTS_TITLE, ENT_QUOTES, 'UTF-8'); ?>" href="comments.php?sel=offline&amp;a=<?php echo htmlspecialchars($artId, ENT_QUOTES, 'UTF-8'); ?>&amp;page=1"><?php echo htmlspecialchars($nbComsToValidate, ENT_QUOTES, 'UTF-8'); ?></a></li>
								<li><?php echo htmlspecialchars(L_COMMENT_ONLINE, ENT_QUOTES, 'UTF-8'); ?> : <a title="<?php echo htmlspecialchars(L_VALIDATED_COMMENTS_TITLE, ENT_QUOTES, 'UTF-8'); ?>" href="comments.php?sel=online&amp;a=<?php echo htmlspecialchars($artId, ENT_QUOTES, 'UTF-8'); ?>&amp;page=1"><?php echo htmlspecialchars($nbComsValidated, ENT_QUOTES, 'UTF-8'); ?></a></li>
							</ul>
						</li>
						<li><a href="comment_new.php?a=<?php echo htmlspecialchars($artId, ENT_QUOTES, 'UTF-8'); ?>" title="<?php echo htmlspecialchars(L_ARTICLE_NEW_COMMENT_TITLE, ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars(L_ARTICLE_NEW_COMMENT, ENT_QUOTES, 'UTF-8'); ?></a></li>
					</ul>
				<?php endif; ?>
